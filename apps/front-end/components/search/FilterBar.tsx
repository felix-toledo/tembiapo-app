    ...
    <div className="flex flex-col gap-4 mb-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="flex flex-col gap-1">
          <label className="text-xs font-bold text-gray-500 uppercase ml-1">Profesión</label>
          <select 
        ...
        <div className="flex flex-col gap-1">
          ...
          <select 
            className="w-full px-4 py-3 border-2 border-gray-400 rounded-lg bg-white text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-gray-400 cursor-pointer appearance-none uppercase text-sm"
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleFilterChange('area', e.target.value)}
        ...
        <div className="flex flex-col gap-1">
          ...
          <select 
            className="w-full px-4 py-3 border-2 border-gray-400 rounded-lg bg-white text-gray-900 font-medium focus:outline-none focus:ring-2 focus:ring-gray-400 cursor-pointer appearance-none uppercase text-sm"
            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => handleFilterChange('isVerified', e.target.value)}

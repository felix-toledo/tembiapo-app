...
import { Professional, Field, ServiceArea, ApiSuccessResponse, PaginationData } from '../../types';
...
async function getProfessionals(filters: { [key: string]: string | string[] | undefined }) {
...
export default async function SearchPage(props:{
  ...
  const pagination = professionalsData?.pagination || { page: 1, totalPages: 1, limit: 10, total: 0 };
            ...
            <FilterBar fields={fieldsData} areas={areasData} />
              ...
              {professionals.length > 0 ? (
                ...
                professionals.map((pro: Professional) => {
                  ...
                  const mainField = pro.fields.find(f => f.isMain)?.name || pro.fields[0]?.name || "Sin rubro";

...
export class ProfileController {
    ...
    async createProfessional(@Body() createProfesionalRequest : createProfessionalRequestDTO, @Req() req){
        const userId = req.user.userId
        return await this.profileService.createProfessionalProfile(userId,createProfesionalRequest)
    }
}
